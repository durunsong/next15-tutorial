...
const techStack: TechStackItem[] = [
  ...
  {
    name: 'WebAssembly',
    description: '高性能 Web 二进制格式',
    category: 'frontend',
    icon: Code,
    features: ['近原生性能', '多语言支持', '安全沙箱', '渐进增强'],
    officialLink: 'https://webassembly.org',
    version: '2.0',
    difficulty: 'advanced',
    color: 'bg-purple-600 text-white',
  },
  {
    name: 'Web Workers',
    description: '浏览器后台线程技术',
    category: 'frontend',
    icon: Zap,
    features: ['并行计算', '非阻塞操作', '离线缓存', '数据处理'],
    officialLink: 'https://developer.mozilla.org/docs/Web/API/Web_Workers_API',
    version: 'ES2022',
    difficulty: 'advanced',
    color: 'bg-yellow-600 text-white',
  },
  // 高级后端技术
  {
    ...
    category: 'backend',
    icon: Zap,
    features: ['HTTP/2', 'Protocol Buffers', '流式处理', '多语言支持'],
          ...
          <div className="flex flex-wrap gap-2">
            {categories.map(category => (
              <button
                ...
                className={`flex items-center cursor-pointer space-x-2 px-4 py-2 rounded-lg text-sm font-medium transition-colors ${
        ...
        <div className="mb-6 p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-200 text-sm font-medium cursor-pointer"
            >
              清除筛选
            </button>
          </div>
          ...
          <div className="col-span-full flex flex-col items-center justify-center py-16">
            ...
            <p className="text-gray-600 dark:text-gray-400 text-center max-w-md">
              ...
              <button
                ...
                className="text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-200 ml-1 cursor-pointer"
              >
                查看全部技术
              </button>
            </p>
