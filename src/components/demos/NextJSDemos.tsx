    ...
    <div className="space-y-6">
      ...
      <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-4">
        ...
        <div className="space-y-3">
          <div>
            <span className="text-sm font-medium text-gray-700 dark:text-gray-300">路径参数 (params):</span>
            <pre className="mt-1 text-sm bg-gray-100 dark:bg-gray-700 p-2 rounded overflow-x-auto">
              {JSON.stringify(params, null, 2)}
            </pre>
          </div>
          <div>
            <span className="text-sm font-medium text-gray-700 dark:text-gray-300">查询参数 (searchParams):</span>
    ...
    <div className="space-y-6">
      ...
      <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
        ...
        <div className="text-sm text-blue-800 dark:text-blue-200">
          ...
          <p><strong>页面类型:</strong> {protectedRoutes.some(route => currentPath.startsWith(route)) ? '受保护页面' : '公开页面'}</p>
        </div>
      </div>
    </div>
  );
